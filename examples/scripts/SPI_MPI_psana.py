...
# Example1: mpirun -n 4 python SPI_MPI_psana.py --pdb=../input/pdb/3iyf.pdb --geom=../input/lcls/amo86615/PNCCD::CalibV1/Camp.0:pnCCD.1/geometry/0-end.data --beam=../input/beam/amo86615.beam --numPatterns=60 --outDir=../output

# Example2: mpirun -n 4 python SPI_MPI_psana.py --pdb=../input/pdb/3iyf.pdb --geom=../input/lcls/epix10ka/calib/Epix10ka::CalibV1/MecTargetChamber.0:Epix10ka.1/geometry/0-end.data --beam=../input/beam/amo86615.beam --numPatterns=60 --outDir=../output
